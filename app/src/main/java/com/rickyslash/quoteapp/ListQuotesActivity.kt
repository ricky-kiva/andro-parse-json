...
import com.rickyslash.quoteapp.databinding.ActivityListQuotesBinding
    ...
    private fun getListQuotes() {
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                // make 'array' to be 'passed' to 'QuoteAdapter'
                val listQuote = ArrayList<String>()
                val result = String(responseBody!!)
                Log.d(TAG, result)

                try {
                    // get data from 'API' and assign to 'RecyclerView'
